...
def gdpr(update, context):
    ...
    update.effective_message.reply_text(
        ...
        "you from any chats, as that is telegram data, not Erina data. "
...
def src(update, context):
    update.effective_message.reply_text(
        "Hey there! You can find what makes me click [here](www.github.com/SurajRaj/Celluloid).",   
        parse_mode=ParseMode.MARKDOWN,
