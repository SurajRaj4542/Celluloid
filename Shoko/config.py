...
class Config(object):
    ...
    # OPTIONAL
    SUDO_USERS = (
        [696086626, 1183697491, 1099898513, 1939561815, 1201425400, 1250637598, 1353333753, 1213481085, 1691070124, 1313665327, 626886842, 1392872370, 1768681206, 689061386, 1196841159]
